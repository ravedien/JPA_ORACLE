...
import com.poc.repository.impl.AgentDaoImpl;
...
public class AgentRepositoryTest {
	...
	// Agent agent = agentRepository.findOne(new AgentPK(1,
	// sdf.parse("2017-02-23 11:30:12.343")));
	...
	// List<Agent> agentList = agentRepository.fetchAgentAndLicense(1,
	// sdf.parse("2017-02-20 13:08:22.091"));
	...
	// TypedQuery<Agent> query = em.createQuery("SELECT a FROM Agent a JOIN
	// FETCH a.agentLicenses al where a.agentId = :agentId and a.startDateTime =
	// :startDateTime", Agent.class);
	// query.setParameter("agentId", 1);
	// query.setParameter("startDateTime", sdf.parse("2017-02-20
	// 13:08:22.091"));
	...
	// Predicate pre2 = cb.equal(root.get("startDateTime"),
	// sdf.parse("2017-02-20 13:08:22.091"));
	...
	// EntityGraph<?> agentGraph =
	// em.getEntityGraph(Agent.GRAPH_AGENT_LICENSES);
	// Map<String,Object> hints = new HashMap<>();
	// hints.put("javax.persistence.fetchgraph", agentGraph);
	// Agent agent = em.find(Agent.class, new AgentPK(1, sdf.parse("2017-02-20
	// 13:08:22.091")), hints);
	...
	// Agent agent = agentDao.findOne(new AgentPK(1, sdf.parse("2017-02-20
	// 13:08:22.091")) );
	// logger.info(agent.toString());
	//
	// }
	...
	// TypedQuery<Agent> query = em.createNamedQuery(Agent.QUERY_FIND_AGENTPK ,
	// Agent.class);
	// query.setParameter(Agent.PARAM_AGENT_ID, 1);
	// query.setParameter(Agent.PARAM_START_DATE_TIME, sdf.parse("2017-02-20
	// 13:08:22.091"));
	// Agent agent = query.getSingleResult();
